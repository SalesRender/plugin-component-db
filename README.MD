...
- `salesrender/plugin-component-settings` -- `Settings` class as a real-world `SinglePluginModelInterface` example
- `salesrender/plugin-component-access` -- `Registration` class using `SinglePluginModelInterface`
